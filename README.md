...
Najlepiej będzie wydrukowac na oddzielnej stronie bo nic teraz nie widać a widać musi być. Tak mówił gość
...
## TO DO - dokonczyc tabelke i ogarnac ta weryfikacje

| Transaction name                                       | Required recources        | Verification Yes/No | Comments |
|--------------------------------------------------------|---------------------------|--------------|----------|
...
| Adding, modification, removal of Devices data       | Devices, Models, Manufacturers and Orders Table             |              |    -      |
| Devices data view          | Devices, Models, Manufacturers and Orders Table             |              |   -       |
| Adding, modification, removal of Orders data           | Clients, Devices, Models, Manufacturers and Orders Table             |              |   -       |
| Orders data view           | Clients, Devices, Models, Manufacturers and Orders Table             |              |   -       |
